package com.danny.vocabularynotebook.services.jobs;
...
public class TestCollectionGenerator {
    ...
    @Async
    public void generateTestsForWords(
            TestCollection testCollection,
            List<Word> words,
            TestCollectionGenerationJob testCollectionGenerationJob
    ) {

        testCollectionGenerationJob.setStatus(TestCollectionGenerationJob.JobStatus.RUNNING);
        ...
        testCollectionGenerationJob.setStatus(TestCollectionGenerationJob.JobStatus.COMPLETED);
        testCollectionGenerationJobRepository.save(testCollectionGenerationJob);
    }
}
